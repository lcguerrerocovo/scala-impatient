// Example: Chapter 7: Packages and Imports
...
object Chapter07 {
  ...
  class Random
  //   see: [impatient_exercises.random](https://github.com/lcguerrerocovo/scala-impatient/blob/master/src/main/scala/impatient_exercises/random/package.scala)
